...
if(isset($_POST['add_to_cart'])){
    ...
    $_SESSION['cart'][] = $item;
    header("Location: card7.php");
    exit;
}

// Fetch all Venkatagiri Sarees
$result = $conn->query("SELECT * FROM sarees WHERE type='venkatagiri'");
?>
...
<title>Venkatagiri Sarees</title>

<!-- ✅ Use same inline CSS from card6 -->
...
<body>
    ...
    <section class="hero">
        <div class="container">
            <div class="hero-content slide-in-left">
                <h1>Venkatagiri Silk Sarees</h1>
                <p>Step into elegance with Venkatagiri Sarees, known for their lightweight texture and rich zari work. Handwoven to perfection, these sarees reflect centuries of royal tradition and artistry.</p>
                <a href="#sarees" class="btn btn-primary">Explore Collection</a>
            </div>
            <div class="hero-image slide-in-right">
                <img src="../images/venkatagiri/mainvenkatagiri.jpg" alt="Venkatagiri Saree">
            </div>
        </div>
    </section>
    ...
    <section class="sarees-section" id="sarees">
        <div class="container">
            <h2 class="section-title">Our Venkatagiri Collection</h2>
            ...
            <div class="text-center">
                <a href="../php/view_cart.php" class="cart-link">
        ...
        <div class="container">
            <div class="footer-content">
                <div class="footer-section">
                    <h3>About Us</h3>
                    <p>DMM Sarees brings you the finest handwoven sarees, preserving the cultural heritage of Indian weavers.</p>
                </div>
                <div class="footer-section">
                    <h3>Quick Links</h3>
                    <ul>
                ...
                <div class="footer-section">
                    <h3>Contact Info</h3>
                    <p><i>📍</i> 123 Silk Street, Dharmavaram, India</p>
