...
if(isset($_POST['add_to_cart'])){
    ...
    $_SESSION['cart'][] = $item;
    header("Location: card5.php");
    exit;
}

// Fetch all Pochampally Sarees
$result = $conn->query("SELECT * FROM sarees WHERE type='pochampally'");
?>
...
<title>Pochampally Silk Sarees</title>
...
<section class="hero">
    <div class="container">
        <div class="hero-content slide-in-left">
            <h1>Pochampally Silk Sarees</h1>
            <p>Discover the vibrant geometry of Pochampally Ikat silk sarees — meticulously woven for intricate patterns and colour transitions, combining tradition with bold style.</p>
            <a href="#sarees" class="btn btn-primary">Explore Collection</a>
        </div>
        <div class="hero-image slide-in-right">
            <img src="../images/pochampally/mainpocham.jpg" alt="Pochampally Saree">
        </div>
    </div>
</section>
...
<section class="sarees-section" id="sarees">
    <div class="container">
        <h2 class="section-title">Our Pochampally Collection</h2>
...
<footer id="foot">
    <div class="container">
        <div class="footer-content">
            ...
            <div class="footer-section">
                <h3>Contact Info</h3>
                <p><i>📍</i> Pochampally, Telangana, India</p>
