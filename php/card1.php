...
// Fetch all Pure Silk Sarees
$result = $conn->query("SELECT * FROM sarees WHERE type='pure_silk'");
?>
...
<body>
    ...
    <section class="hero">
        <div class="container">
            <div class="hero-content slide-in-left">
                ...
                <p>Discover our exquisite collection of handcrafted pure silk sarees, each telling a story of tradition and elegance. Made with premium silk and intricate designs, these sarees are perfect for special occasions.</p>
                <a href="#sarees" class="btn btn-primary">Explore Collection</a>
            </div>
            <div class="hero-image slide-in-right">
                <img src="../images/silk/bigsilk.jpg" alt="Pure Silk Saree">
            </div>
        </div>
    </section>
    ...
    <section class="sarees-section" id="sarees">
        <div class="container">
            <h2 class="section-title">Our Pure Silk Collection</h2>
