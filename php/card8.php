...
if(isset($_POST['add_to_cart'])){
    ...
    $_SESSION['cart'][] = $item;
    header("Location: card8.php");
    exit;
}

// Fetch all Kuppadam Sarees
$result = $conn->query("SELECT * FROM sarees WHERE type='kuppadam'");
?>
...
<title>Kuppadam Sarees</title>

<!-- ✅ Same inline CSS as card6.php -->
...
<body>
        ...
        <div class="container header-container">
            ...
            <nav>
                ...
                <ul>
                    ...
                    <li><a href="../php/view_cart.php" class="active">
    ...
    <section class="hero">
        <div class="container">
            <div class="hero-content slide-in-left">
                <h1>Kuppadam Silk Sarees</h1>
                <p>Explore the timeless charm of Kuppadam Sarees, renowned for their elegant borders, delicate zari patterns, and premium silk quality. Perfect for weddings and festive occasions.</p>
                <a href="#sarees" class="btn btn-primary">Explore Collection</a>
            </div>
            <div class="hero-image slide-in-right">
                <img src="../images/kuppadam/mainkuppadam.jpg" alt="Kuppadam Saree">
            </div>
        </div>
    </section>
    ...
    <section class="sarees-section" id="sarees">
        <div class="container">
            <h2 class="section-title">Our Kuppadam Collection</h2>
        ...
        <div class="container">
            <div class="footer-content">
                <div class="footer-section">
                    <h3>About Us</h3>
                    <p>DMM Sarees offers exquisite handwoven silk sarees, celebrating India's rich textile heritage.</p>
                </div>
                <div class="footer-section">
                    <h3>Quick Links</h3>
                    <ul>
