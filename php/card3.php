...
// Fetch all Banaras Sarees
$result = $conn->query("SELECT * FROM sarees WHERE type='banaras'");
?>
...
<body>
    ...
    <section class="hero">
        <div class="container">
            <div class="hero-content slide-in-left">
                <h1>Banaras Sarees</h1>
                <p>Experience the timeless artistry of Banaras sarees — woven with gold and silver threads, rich colors, and majestic motifs that reflect India’s royal tradition.</p>
                <a href="#sarees" class="btn btn-primary">Explore Collection</a>
            </div>
            <div class="hero-image slide-in-right">
                <img src="../images/banaras/mainbanaras.jpg" alt="Banaras Saree">
            </div>
        </div>
    </section>
    ...
    <section class="sarees-section" id="sarees">
        <div class="container">
            <h2 class="section-title">Our Banaras Collection</h2>
