...
if(isset($_POST['add_to_cart'])){
    ...
    $_SESSION['cart'][] = $item;
    header("Location: card6.php");
    exit;
}

// Fetch Gadwal Silk Sarees
$result = $conn->query("SELECT * FROM sarees WHERE type='gadwal'");
?>
...
<title>Gadwal Silk Sarees</title>
...
<body>
    ...
    <section class="hero">
        <div class="container">
            <div class="hero-content slide-in-left">
                <h1>Gadwal Silk Sarees</h1>
                <p>Experience the royal elegance of Gadwal Silk Sarees — woven with golden zari borders and vibrant hues that celebrate South Indian craftsmanship at its finest.</p>
                <a href="#sarees" class="btn btn-primary">Explore Collection</a>
            </div>
            <div class="hero-image slide-in-right">
                <img src="../images/gadwal/maingadwal.jpg" alt="Gadwal Silk Saree">
            </div>
        </div>
    </section>
    ...
    <section class="sarees-section" id="sarees">
        <div class="container">
            <h2 class="section-title">Our Gadwal Collection</h2>
