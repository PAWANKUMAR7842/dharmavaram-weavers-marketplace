...
// Fetch all Kanchipuram Sarees
$result = $conn->query("SELECT * FROM sarees WHERE type='kanchipuram'");
?>
...
<title>Kanchipuram Sarees</title>
...
<body>
    ...
    <section class="hero">
        <div class="container">
            <div class="hero-content slide-in-left">
                <h1>Kanchipuram Sarees</h1>
                <p>Celebrate South India's rich weaving legacy with our handwoven Kanchipuram sarees — crafted with pure mulberry silk and golden zari to bring timeless grace.</p>
                <a href="#sarees" class="btn btn-primary">Explore Collection</a>
            </div>
            <div class="hero-image slide-in-right">
                <img src="../images/kanchipuram/mainkanchi.jpg" alt="Kanchipuram Saree">
            </div>
        </div>
    </section>
    ...
    <section class="sarees-section" id="sarees">
        <div class="container">
            <h2 class="section-title">Our Kanchipuram Collection</h2>
    ...
    <footer  id="foot">
        <div class="container">
            <div class="footer-content">
                ...
                <div class="footer-section">
                    <h3>Contact Info</h3>
                    <p><i>📍</i> 123 Silk Street, Kanchipuram, India</p>
